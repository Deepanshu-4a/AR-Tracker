...
export function VendorTransactions({ vendorId }) {
  ...
  const rows = useMemo(
    () => [
      { type: "Bill", num: "ATS-00001", date: "2025-01-31", dueDate: "2025-03-02", amount: 21250, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00002", date: "2025-02-28", dueDate: "2025-03-30", amount: 19000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00003", date: "2025-03-31", dueDate: "2025-04-30", amount: 21000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00004", date: "2025-04-30", dueDate: "2025-05-30", amount: 22000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00005", date: "2025-05-31", dueDate: "2025-06-30", amount: 21000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00006", date: "2025-06-30", dueDate: "2025-07-30", amount: 20000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00007", date: "2025-07-31", dueDate: "2025-08-30", amount: 18000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00008", date: "2025-08-31", dueDate: "2025-09-30", amount: 21000, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00009", date: "2025-09-30", dueDate: "2025-10-30", amount: 21750, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00010", date: "2025-10-31", dueDate: "2025-11-30", amount: 23500, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00011", date: "2025-11-30", dueDate: "2025-12-30", amount: 17375, openBalance: 0, status: "closed", kind: "bills" },
      { type: "Bill", num: "ATS-00012", date: "2025-12-31", dueDate: "2026-01-30", amount: 22000, openBalance: 0, status: "closed", kind: "bills" },
    ],
    [],
  );
  ...
  const filtered = useMemo(() => {
    ...
    return rows
      ...
      .filter((r) => {
        ...
        return filterBy === "open" ? r.status === "open" : r.status === "closed";
      })
      .filter((r) => {
    ...
    <Card className="border border-border/60 rounded-xl bg-white overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-4 px-4 py-3 bg-[#f3f4f6] border-b">
        ...
        <div className="ml-auto text-[11px] text-[#6b7280]">
          Vendor:{" "}
          <span className="font-medium text-[#374151]">{vendorId || "—"}</span>
        </div>
      </div>
        ...
        <table className="w-full table-fixed border-collapse">
          <thead className="sticky top-0 z-10 bg-white border-b">
            <tr className="text-[11px] font-semibold text-[#6b7280] uppercase">
              ...
              <th className="px-4 py-2 text-left border-r w-[18%]">Due Date</th>
              <th className="px-4 py-2 text-left border-r w-[14%] pd-6">Aging</th>
              <th className="px-4 py-2 text-right border-r w-[14%]">Amount</th>
      ...
      <div className="flex flex-wrap items-center gap-3 px-4 py-3 bg-[#f3f4f6] border-t">
        ...
        <div className="ml-auto text-[11px] text-[#6b7280]">
          Selected:{" "}
          <span className="font-medium text-[#374151]">{selectedNum || "—"}</span>
        </div>
      </div>
    </Card>
  );
