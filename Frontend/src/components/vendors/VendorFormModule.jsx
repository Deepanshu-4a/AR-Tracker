...
export function VendorFormModal({
  ...
  const modalTitle = mode === "edit" ? "Edit Vendor" : "New Vendor";
  const saveLabel = mode === "edit" ? "Update Vendor" : "Save Vendor";
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 p-6 bg-card overflow-hidden">
            ...
            <div className={activeTab === "payment" ? "block h-full" : "hidden"}>
              <PaymentSettingsTab formData={formData} setFormData={setFormData} />
            </div>
            ...
            <div className={activeTab === "additional" ? "block h-full" : "hidden"}>
