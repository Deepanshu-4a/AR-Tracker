...
export const mockCustomers = [
  {
    ...
    addressInfo: {
      companyName: "MegaMart",
      title: "Mr.",
      firstName: "John",
      middleInitial: "A",
      lastName: "Smith",
      jobTitle: "Finance Manager",
      mainPhone: "+1 555-111-2222",
      fax: "+1 555-111-3333",
      workPhone: "+1 555-111-4444",
      mainEmail: "finance@megamart.com",
      mobile: "+1 555-111-5555",
      ccEmail: "ap@megamart.com",
      website: "https://megamart.com",
      other1: "Portal Ref",
    ...
    paymentSettings: {
      ...
      printNameOnCheckAs: "MegaMart",
    },

    salesTax: {
      customerTaxId: "TX-123456",
    },
